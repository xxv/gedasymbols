# $Id$
Element[0x0 "Low Profile Modular 10p10c Connector AKA RJ50" "X" "RJ50" 26575 15000 -9843 -9500 0 100 ""]
(
	# signal pins
	...
	Attribute("ref" "Bel Stewart Connector Part Number SS-701010-NF")
	)
