...
Element[""        ""     ""     ""       10      10     2500    40000  1     100   "showname"]
(
  # ===================================================================================================
  # Pin[...]
  #     rX       rY       Thickness  Clearance   Mask      Drill     "Name"          "Number" SFlags]
    Pin[5000          0   5000       1500        1000      2000      ""              "1"       ""]
    Pin[5000      70000   5000       1500        1000      2000      ""              "2"       ""]
  # ===================================================================================================
  # ElementLine[...]
  #             rX1         rY1        rX2         rY2       Thickness
    ElementLine[0           25000      10000       25000      1020]
    ElementLine[10000       25000      10000       45000      1020]
    ElementLine[10000       45000      0           45000      1020]
    ElementLine[0           25000      0           45000      1020]
    ElementLine[5000            0      5000        25000      1020]
    ElementLine[5000        45000      5000        70000      1020]
  # ===================================================================================================
  # ElementArc[...]
  ...
  #            rX       rY            Width       Height    StartAngle       DeltaAngle       Thickness
    ...
    ElementArc[5000      70000        3000        3000      0                360              750]
  # ===================================================================================================
)
# =====================================================================================================
