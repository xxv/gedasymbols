...
Element[""        ""     ""     ""       10      10     0       31000  0     100   "showname"]
(
  # ===================================================================================================
  # Pin[...]
  #     rX       rY       Thickness  Clearance   Mask      Drill     "Name"          "Number" SFlags]
    Pin[5000       5000   5000       1500        1000      2000      ""              "1"       "square"]
    Pin[5000      15000   5000       1500        1000      2000      ""              "3"       ""]
    Pin[5000      25000   5000       1500        1000      2000      ""              "5"       ""]
    Pin[15000      5000   5000       1500        1000      2000      ""              "2"       ""]
    Pin[15000     15000   5000       1500        1000      2000      ""              "4"       ""]
    Pin[15000     25000   5000       1500        1000      2000      ""              "6"       ""]
  # ===================================================================================================
  # ElementLine[...]
  #             rX1         rY1        rX2         rY2       Thickness
    ElementLine[0           0          20000       0          1020]
    ElementLine[20000       0          20000        30000     1020]
    ElementLine[20000        30000     0            30000     1020]
  ...
  #            rX       rY            Width       Height    StartAngle       DeltaAngle       Thickness
    ...
    ElementArc[15000      5000        3000        3000      0                360             540]
    ElementArc[15000     15000        3000        3000      0                360             540]
    ElementArc[15000     25000        3000        3000      0                360             540]
  # ===================================================================================================
)
# =====================================================================================================
